...
--Bauble Arena
    ...
    and getHp("player") < 40 then
      UseItemByName("Bauble of True Blood", "player")
    end
    if Party1Lowest
    and _LoS("party1")
    and UnitBuffID("player", 59578) 
    and getHp("party1") < 40 then
      UseItemByName("Bauble of True Blood", "party1")
    end
    if Party2Lowest
    and _LoS("party2")
    and UnitBuffID("player", 59578) 
    and getHp("party2") < 40 then
      UseItemByName("Bauble of True Blood", "party2")
    end
...
--Heal Pets
    ...
    and _LoS("partypet1")
    and getHp("partypet1") < 85
    and getHp("partypet1") < getHp("party1")
    and getHp("partypet1") < getHp("party2")
    and getHp("partypet1") < getHp("player")
    and getHp("partypet1") < getHp("partypet2")
    then _castSpell(48785, "partypet1")
    end

    if UnitBuffID("player", 54149) 
    and _LoS("partypet2")
    and getHp("partypet2") < 85
    and getHp("partypet2") < getHp("party1")
    and getHp("partypet2") < getHp("party2")
    and getHp("partypet2") < getHp("player")
    and getHp("partypet2") < getHp("partypet1")
    then _castSpell(48785, "partypet2")
    end

    --holy shock
    if getHp("partypet1") < 85
    and _LoS("partypet1")
    and getHp("partypet1") < getHp("party1")
    and getHp("partypet1") < getHp("party2")
    and getHp("partypet1") < getHp("player")
    and getHp("partypet1") < getHp("partypet2")
    then _castSpell(48825, "partypet1")
    end

    if getHp("partypet2") < 85
    and _LoS("partypet2")
    and getHp("partypet2") < getHp("party1")
    and getHp("partypet2") < getHp("party2")
    and getHp("partypet2") < getHp("player")
    and getHp("partypet2") < getHp("partypet1")
    then _castSpell(48825, "partypet2")
    end
...
--Holy Shock
    if PlayerLowest
    and getHp("player") < 70 then 
      _castSpell(48825,"player")
    end

    if Party1Lowest
    and _LoS("party1")
    and getHp("party1") < 70 then 
      _castSpell(48825,"party1")
    end

    if Party2Lowest
    and _LoS("party2")
    and getHp("party2") < 70 then 
      _castSpell(48825,"party2")
    end
--Flash of Light
    if PlayerLowest
    and getHp("player") < 85 then 
